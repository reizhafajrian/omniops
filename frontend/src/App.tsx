...
export const App: React.FC = () => {
  const [isAuthenticated, setIsAuthenticated] = useState<boolean>(() => {
    return localStorage.getItem('omniops_admin_logged_in') === 'true';
  });
  ...
  const handleLogout = () => {
    localStorage.removeItem('omniops_admin_logged_in');
