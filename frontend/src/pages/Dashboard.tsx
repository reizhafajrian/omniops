            ...
            <div className="space-y-6">
              ...
              {isError && (
                <Alert variant="destructive">
                  ...
                  <AlertDescription>
                    <strong>Failed to connect to GitOps Engine API.</strong>{' '}
                    {error?.message || 'Check your GITOPS_TOKEN configuration or ensure the engine backend is running.'}
                    <Button
                      variant="destructive"
                      size="sm"
                      onClick={() => refetch()}
