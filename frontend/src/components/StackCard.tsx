...
import { GitBranch, GitCommit, FileCode, Clock, ShieldCheck, Terminal, Trash2, AlertTriangle, Lock, Loader2 } from 'lucide-react';
import {
  Card,
  CardContent,
  CardHeader,
      ...
      >
        ...
        <CardContent className="flex flex-col flex-1 gap-4">
          ...
          <div className="grid grid-cols-2 gap-2 text-xs font-mono">
            <div className="flex items-center gap-1.5 p-2 rounded-lg bg-muted/30 border border-border/50 text-muted-foreground min-w-0 transition-colors group-hover:bg-muted/50">
